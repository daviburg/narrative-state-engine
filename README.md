...
sessions/
  session-001/
    ...
    exports/
      book-skeleton.md           # Fiction/book outline (generated by export_book_skeleton.py)
...
Build a focused entity snapshot for a specific turn (uses the V2 catalog layout):
...
Use `--force` to overwrite an existing V2 layout. All tools support both layouts with automatic format detection.
