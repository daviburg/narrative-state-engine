...
- **Non-standard key coercion** (#170) — remaps common non-standard LLM keys (`equipment`, `location`, `abilities`, `relations`, etc.) into their correct V2 schema slots before validation, transforming most schema failures into successful merges
