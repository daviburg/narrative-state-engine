...
- Require one connectivity attempt with an explicit timeout; a failure produces `blocked-external`, not rerouting or repeated task creation. Specify a deduplication key covering target, operation, and SHA.
